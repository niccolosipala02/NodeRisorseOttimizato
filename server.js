...
function crea(req, res){
    ...
    switch(risorsa){
        ...
        case '/index.html':
            ...
            res.write("<input type='button' value='Vai a pag3' class='btn btn-danger' id='btnP3' />");
            res.end("</body></html>");  
            break;
        ...
        default:
            ...
            console.log("Risorsa chiesta: "+risorsa);
            console.log("ext: "+extName );
            console.log("path.basename (risorsa chiamata): "+path.basename(risorsa));
            console.log("cartella della risors: "+path.dirname(risorsa));
            switch(extName){
                case '.css':
